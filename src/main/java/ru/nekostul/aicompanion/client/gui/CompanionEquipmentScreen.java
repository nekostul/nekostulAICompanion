...
public final class CompanionEquipmentScreen extends EffectRenderingInventoryScreen<CompanionEquipmentMenu>
    ...
    private static final ResourceLocation PICKAXE_ICON_LOCATION =
            new ResourceLocation(AiCompanionMod.MOD_ID, "textures/gui/pickaxe.png");
    private static final ResourceLocation SHOVEL_ICON_LOCATION =
    ...
    private void renderNpcModel(GuiGraphics guiGraphics, int panelX, int panelY) {
        ...
        InventoryScreen.renderEntityInInventoryFollowsMouse(guiGraphics, modelX, modelY, 30,
                (float) modelX - this.xMouse, (float) (modelY - 50) - this.yMouse, companion);
    }

    private void renderNpcToolIcons(GuiGraphics guiGraphics) {
        renderToolIcon(guiGraphics, 0, PICKAXE_ICON_LOCATION);
